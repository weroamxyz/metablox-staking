...
var ErrDIDMismatch = errors.New("DID in request response mis-match")
var ErrSignatureVerifyError = errors.New("signature verify error")
var ErrInvalidValidator = errors.New("failed to find credential for validator")
var ErrInvalidMiner = errors.New("failed to find credential for miner")
